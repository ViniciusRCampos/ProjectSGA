    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-criar" id="btn_criar_produto">Salvar</button>
                <button type="button" class="btn btn-primary btn-editar d-none" id="modal_btn_editar_produto">Salvar</button>
            </div>
        </div>
    </div>
</div>